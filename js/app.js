var enemySpeed = [75, 110, 140, 290, 320, 370, 450];
var columns = [0, 100, 200, 300, 400, 500, 600, 700, 800, 900];
var rows = [81, 162, 243];
...
Player.prototype.checkCollide = function(){
    ...
    //If player touches bug or water, they lose a life
...
// When no more lives are left, its game over
...
function gameOver() {
    var removeScore = document.getElementById('score');
        ...
        ctx.font="40px Lato";
        ctx.fillText("Your final score is " + score, 300, 250);
        keyEnabled = false;
}
